...
import BrushIcon from '../public/statics/brush.svg';
...
const AddTodo: FC = () => {
  ...
  const [selectedColor, setSelcetedColor] = useState<TodoType['color']>();
        ...
        <div className="add-todo-color-list">
          {['red', 'orange', 'yellow', 'green', 'blue', 'navy'].map((color, index) => (
            <button
              ...
              onClick={() => { setSelcetedColor(color as TodoType['color']); }}
            />
          ))}
        </div>
        <BrushIcon />
